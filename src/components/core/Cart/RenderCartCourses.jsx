  ...
  return (
    <div >
    {
        cart.map((course, index) => (
            <div key={index} className='flex flex-row gap-x-2 justify-between border-b-[1px] border-richblack-300 py-5 w-full'>
                <div className='flex flex-row gap-x-4'>
                    <img alt="" className='flex justify-center items-center w-[200px] h-[150px] object-cover rounded-md md:block sm:hidden'
